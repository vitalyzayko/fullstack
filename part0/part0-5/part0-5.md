...
participant server
    ...
    activate server
    server-->>browser: HTML document with information and links to the CSS (main.css) and Javascript (spa.js) files
    deactivate server
    ...
    Note right of browser: The browser requests the spa.js file with java script code
    ...
    activate server
    server-->>browser: the JSON file, content - [application/json charset=utf-8] [{content: "", date: "2025-11-11T22:17:08.207Z"}, {content: "", date: "2025-11-11T22:17:08.351Z"},…]
    deactivate server
